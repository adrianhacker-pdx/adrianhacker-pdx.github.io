Project Summary:  I was hired to write one article that illustrates how the virtual computing machine inside the ethereum blockchain
executed transaction for sending, receiving, and smart contract oriented calls.  I had no previous experience or knowledge prior
to completing this article.  I researched, sorted, and summarized.
