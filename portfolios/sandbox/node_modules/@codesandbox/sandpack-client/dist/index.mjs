import { _ as __awaiter, a as __generator } from './types-0877c553.mjs';
export { S as SandpackLogLevel, d as addPackageJSONIfNeeded, c as createError, b as createPackageJSON, e as extractErrorDetails, f as normalizePath, n as nullthrows } from './types-0877c553.mjs';
import 'outvariant';
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    Client = _c.sent();
                    return [3 /*break*/, 7];
                case 3: return [4 /*yield*/, import('./index-ec7d9378.mjs').then(function (m) { return m.SandpackStatic; })];
                case 4:
                    Client = _c.sent();
                    return [3 /*break*/, 7];
