Project Summary:  I completed a freelance bounty posted on gitcoin.co to write an article explaining what a stateless client 
meant in terms of computing machine state with respect to a blockchain system user.  The finished article is hosted at this URL: 
